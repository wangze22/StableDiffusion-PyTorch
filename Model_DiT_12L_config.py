...
if environment == 'server':
    ...
    train_ldm_output_root = 'runs_DiT_12L_server'
else:
    ...
    train_ldm_output_root = 'runs_DiT_12L_PC'
...
ldm_text_condition_cond_drop_prob = 0.9
...
ldm_image_condition_cond_drop_prob = 0.9
...
train_vqvae_latent_dir_name = 'vqvae_latents_29'
...
dit_model_config = {
    'hidden_size'     : 288,
    'patch_size'      : 2,
    'timestep_emb_dim': diffusion_model_config['time_emb_dim'],
    'num_layers'      : 12,
    'num_heads'       : 9,
    'head_dim'        : 32,
