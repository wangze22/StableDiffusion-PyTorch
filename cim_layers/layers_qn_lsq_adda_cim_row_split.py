...
# ====================================================================== #
class Conv2d_lsq_adda_cim_row_split(nn.Conv2d):
    def __init__(self,
                 in_channels,
                 out_channels,
                 kernel_size,
        ...
        if self.row_split:
            for key, weight_info in self.weight_mapping_info.items():
                ...
                while current_row < end_row:
                    ...
                    current_block_end = min((current_row // self.row_block + 1) * self.row_block, end_row)
...
class Linear_lsq_adda_cim_row_split(nn.Linear):
