...
from cim_layers.layers_qn import *
...
if __name__ == '__main__':
    ...
    tt_state_dict = qn_net.state_dict()
    nn_net.load_state_dict(tt_state_dict, strict = False)
