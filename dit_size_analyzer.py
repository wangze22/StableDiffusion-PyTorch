...
def build_dit_model_config(condition_config: dict) -> dict:
    """Prepare the DiT model configuration using CelebHQ parameters."""
    model_config = {
        'hidden_size': 288,
        'patch_size': 2,
...
def main():
    ...
    dit_model_config = build_dit_model_config(condition_config)
